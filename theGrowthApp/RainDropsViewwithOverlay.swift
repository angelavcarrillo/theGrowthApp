        ...
        ZStack{
            ...
            HStack(alignment: .center){
                ...
                //disregard this line of code for now if it the links don't work I will be redoing them (isTaskComplete ? "emptyRaindrop" : "fullRaindrop")
                    .resizable()
                    .scaledToFit()
                    .scaleEffect(animate ? 0.9 : 0.5)
                    //.animation (.easeInOut(duration:4.2).repeatForever(autoreverses: true),value: animate)
...
#Preview {
    RainDropsViewwithOverlay(imageName:"rain-drop",
                             questionText:"What is the color of the sky?",
                             isReflectionTask: false)
}
